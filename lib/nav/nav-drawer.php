<?php
class Nav_Drawer extends Walker_Nav_Menu{
  ...
  public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
    ...
    $item_output  = $args->before;
		...
		$item_output .= in_array('menu-item-has-children', $classes) ? get_component('svg', ['icon' => 'angle-left', 'height' => 17, 'width' => 9, 'viewbox' => '0 0 9 17', 'title' => '']) : null;
    $item_output .= '</a>';
